...
namespace SerialOutputEx
{
    ...
    internal class PluginMain : AssemblyPluginBase, IExtension
    {
        ...
        {
            //MessageBox.Show("Scenario Opened");
            //Extensions.GetExtension<INative>().Started += MassageTest;

            flgScenarioOpened = true;
            flgFirstSend = true;
        }

        /*private void MassageTest(object sender, StartedEventArgs e)
        {
            MessageBox.Show("Station Jump");
        }*/
